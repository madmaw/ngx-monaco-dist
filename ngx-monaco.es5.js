import { Directive, ElementRef, EventEmitter, HostListener, Inject, Injectable, InjectionToken, Input, NgModule, NgZone, Optional, Output } from '@angular/core';
 ...
 */
var COMPLETION_PROVIDERS = new InjectionToken('Completion Provider');
/**
 * Use this token to inject the default monaco editor options.
 */
var MONACO_EDITOR_OPTIONS = new InjectionToken('Monaco Editor Options');
...
var MonacoEditorService = /** @class */ (function () {
    ...
    function MonacoEditorService(completionProviders, editorOptions, zone) {
        ...
        this.zone = zone;
        this.onFileChange = new Subject$1();
        this.fileChange$ = this.onFileChange.asObservable();
        this.bootstrap$ = Observable$1.create(function (observer) {
 ...
 */
export { MonacoEditorModule, MonacoEditorDirective, MonacoEditorService, COMPLETION_PROVIDERS, MONACO_EDITOR_OPTIONS };
//# sourceMappingURL=ngx-monaco.es5.js.map
